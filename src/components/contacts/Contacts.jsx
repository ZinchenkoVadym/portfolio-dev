          ...
          <div className='contacts__form__body'>
            <div className='text__form'>
              ...
              <p>I am available for work.
                  Connect with me via phone: 0939664520 or email:
                  zinchenkovadym@gmail.com</p>
            </div>
            <div>
              <form className='form' onSubmit={handleSubmit(onSubmit)} >
                <div className='input__validation'>
                  {errors?.name && <p className='not__valid__input'>
                    {errors?.name?.message}!
                  </p>}
                </div>
                <input
                ...
                />
                <div className='input__validation'>
                  {errors?.email && <p className='not__valid__input'>
                ...
                />
                <div className='input__validation'>
                  {errors?.subject && <p className='not__valid__input'>
                ...
                <div className='input__validation'>
                  {errors?.message && <p className='not__valid__input'>
