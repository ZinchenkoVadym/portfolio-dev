  ...
  const [cards, setCard] = useState([
    {
      ...
      aboutProject: 'This project is a simple layout. ' +
        'In this project I use css, html, jquery',
      id: 1,
      active: false,
    ...
    },
    {
      ...
      aboutProject: 'This project is a React application. ' +
        'In this project I use React, Redux, WeatherMapApi',
      id: 2,
      active: false,
          ...
          {cards.map((card) => {
            return <div
              ...
              <div className='card__body'>
                <svg height="120" viewBox="175.7 78 490.6 436.9" width="120"
